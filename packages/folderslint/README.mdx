...
_Make you project sctructure pretty by linting it_ 🗂
...
```sh
npm install -g @infinum/folderslint
```
...
| `legacy/**`              | ✅&nbsp;&nbsp;The directory `legacy` is accepted.<br/> ✅&nbsp;&nbsp;Any nested directory on _any level_ is accepted.                                                                                                                                                                                                                                                                |
| `components/*/legacy/**` | ✅&nbsp;&nbsp;The directory `components` is accepted.<br/> ✅&nbsp;&nbsp;Any _first level_ nested directory is accepted.<br/> ✅&nbsp;&nbsp;The _second level_ nested directory `legacy` is accepted.<br/> ❌&nbsp;&nbsp;Any other _second level_ nested directory is not accepted.<br/> ✅&nbsp;&nbsp;Any nested directory on _any level_ inside of _legacy_ directory is accepted. |
...
This is the fork of [folderslint](https://github.com/denisraslov/folderslint) by [Denis Raslov](https://github.com/denisraslov).
